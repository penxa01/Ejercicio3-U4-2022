...
class aplicacion():
    ...
    def __init__(self):
        ...
        self.et1 =ttk.Label(self.mainframe, textvariable=self.__pesos).grid(column=2, row=2, sticky=(W, E))
        self.bt1 =ttk.Button(self.mainframe, text='Salir', command=quit).grid(column=3, row=3, sticky=W)
        self.et2 =ttk.Label(self.mainframe, text="dólares").grid(column=3, row=1, sticky=W)
        self.et3 =ttk.Label(self.mainframe, text="es equivalente a").grid(column=1, row=2, sticky=E)
        self.et4 =ttk.Label(self.mainframe, text="pesos").grid(column=3, row=2, sticky=W)
